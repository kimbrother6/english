...
urlpatterns = [
    ...
    path('<str:Class>/', views.class_home, name='class-home'),#if GET_method: Class의 word를 JSON형식으로 return elif PUT_method: 넘어온 정보 저장
    path('<str:Class>/update/', views.class_update, name='class-update'),
